...
mosquitto_pub -r -h <BROKERIP> -u <MQTT_USER> -p <MQTT_PASSWORD> -p 1883 -t "homeassistant/switch/eup_charge/config" -m '{"name": "e-up Charge", "command_topic": "weconnect/vehicles/YOURCARVIN/controls/charging_writetopic", "state_topic": "weconnect/vehicles/YOURCARVIN/domains/charging/chargingStatus/chargingState", "state_on": "charging", "state_off": "readyForCharging", "state_off": "notReadyForCharging", "payload_on": "start", "payload_off": "stop", "unique_id": "eup_charging"}'
`
